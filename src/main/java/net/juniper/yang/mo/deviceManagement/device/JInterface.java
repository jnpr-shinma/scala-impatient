 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/interface"
 * <p>
 * See line 399 in
...
public class JInterface extends YangElement {
    ...
    public static final Tagpath TAG_PATH = new Tagpath("device/interface");
     ...
     */
    public JInterface() {
        super(Devicemgt.NAMESPACE, "interface");
    }
     ...
     */
    public JInterface(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "interface");
     ...
     * @param uuidValue Key argument of child.
     */
    public JInterface(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "interface");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
    ...
    public JInterface clone() {
        JInterface copy;
        try {
            copy = new JInterface(getUuidValue().toString());
