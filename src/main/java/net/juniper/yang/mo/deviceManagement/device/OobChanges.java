 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/oobChanges"
 * <p>
 * See line 416 in
 ...
 */
public class OobChanges extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/oobChanges");
    ...
    /**
     * Constructor for an empty OobChanges object.
     */
    public OobChanges() {
        super(Devicemgt.NAMESPACE, "oobChanges");
    }

    /**
     * Constructor for an initialized OobChanges object,
     * 
     * @param uuidValue Key argument of child.
     */
    public OobChanges(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "oobChanges");
     ...
     * @param uuidValue Key argument of child.
     */
    public OobChanges(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "oobChanges");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public OobChanges clone() {
        OobChanges copy;
        try {
            copy = new OobChanges(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (OobChanges)cloneContent(copy);
    }
     ...
     */
    public OobChanges cloneShallow() {
        OobChanges copy;
        try {
            copy = new OobChanges(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (OobChanges)cloneShallowContent(copy);
    }
