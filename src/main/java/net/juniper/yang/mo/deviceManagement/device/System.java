 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/system"
 * <p>
 * See line 246 in
...
public class System extends YangElement {
    ...
    public static final Tagpath TAG_PATH = new Tagpath("device/system");
     ...
     */
    public System() {
        super(Devicemgt.NAMESPACE, "system");
    }
     ...
     * @return The value of the leaf.
     */
    public Timestamp getLastRebootTimeValue() throws JNCException {
        return (Timestamp)getValue("lastRebootTime");
    }
     ...
     */
    public void setLastRebootTimeValue(Timestamp lastRebootTimeValue)
            throws JNCException {
        setLeafValue(Devicemgt.NAMESPACE,
            "lastRebootTime",
            lastRebootTimeValue,
    ...
    public void setLastRebootTimeValue(long lastRebootTimeValue)
            throws JNCException {
        setLastRebootTimeValue(new Timestamp(lastRebootTimeValue));
    }
