...
package net.juniper.yang.mo.deviceManagement.device.redundancy;
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/redundancy/peer"
 * <p>
 * See line 346 in
...
public class Peer extends YangElement {
    ...
    public static final Tagpath TAG_PATH = new Tagpath("device/redundancy/peer");
     ...
     */
    public Peer() {
        super(Devicemgt.NAMESPACE, "peer");
    }
     ...
     */
    public Peer(DeviceIdRef uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "peer");
     ...
     * @param uuidValue Key argument of child.
     */
    public Peer(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "peer");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
    ...
    public Peer clone() {
        Peer copy;
        try {
            copy = new Peer(getUuidValue().toString());
