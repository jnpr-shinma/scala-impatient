 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/partitions"
 * <p>
 * See line 433 in
 ...
 */
public class Partitions extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/partitions");
    ...
    /**
     * Constructor for an empty Partitions object.
     */
    public Partitions() {
        super(Devicemgt.NAMESPACE, "partitions");
    }

    /**
     * Constructor for an initialized Partitions object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Partitions(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "partitions");
     ...
     * @param uuidValue Key argument of child.
     */
    public Partitions(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "partitions");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
    ...
    public Partitions clone() {
        Partitions copy;
        try {
            copy = new Partitions(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Partitions)cloneContent(copy);
    }
     ...
     */
    public Partitions cloneShallow() {
        Partitions copy;
        try {
            copy = new Partitions(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (Partitions)cloneShallowContent(copy);
    }
