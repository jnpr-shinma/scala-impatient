/* 
 * @(#)AssociatedScripts.java        1.0 19/01/15
 *
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/associatedScripts"
 * <p>
 * See line 425 in
 ...
 */
public class AssociatedScripts extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/associatedScripts");
    ...
    /**
     * Constructor for an empty AssociatedScripts object.
     */
    public AssociatedScripts() {
        super(Devicemgt.NAMESPACE, "associatedScripts");
    }

    /**
     * Constructor for an initialized AssociatedScripts object,
     * 
     * @param uuidValue Key argument of child.
     */
    public AssociatedScripts(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "associatedScripts");
     ...
     * @param uuidValue Key argument of child.
     */
    public AssociatedScripts(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "associatedScripts");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public AssociatedScripts clone() {
        AssociatedScripts copy;
        try {
            copy = new AssociatedScripts(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (AssociatedScripts)cloneContent(copy);
    }
     ...
     */
    public AssociatedScripts cloneShallow() {
        AssociatedScripts copy;
        try {
            copy = new AssociatedScripts(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (AssociatedScripts)cloneShallowContent(copy);
    }
