 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/changeLogs"
 * <p>
 * See line 420 in
 ...
 */
public class ChangeLogs extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/changeLogs");
    ...
    /**
     * Constructor for an empty ChangeLogs object.
     */
    public ChangeLogs() {
        super(Devicemgt.NAMESPACE, "changeLogs");
    }

    /**
     * Constructor for an initialized ChangeLogs object,
     * 
     * @param uuidValue Key argument of child.
     */
    public ChangeLogs(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "changeLogs");
     ...
     * @param uuidValue Key argument of child.
     */
    public ChangeLogs(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "changeLogs");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public ChangeLogs clone() {
        ChangeLogs copy;
        try {
            copy = new ChangeLogs(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (ChangeLogs)cloneContent(copy);
    }
     ...
     */
    public ChangeLogs cloneShallow() {
        ChangeLogs copy;
        try {
            copy = new ChangeLogs(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (ChangeLogs)cloneShallowContent(copy);
    }
