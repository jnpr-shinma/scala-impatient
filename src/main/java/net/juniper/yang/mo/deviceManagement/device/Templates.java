 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/templates"
 * <p>
 * See line 412 in
 ...
 */
public class Templates extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/templates");
    ...
    /**
     * Constructor for an empty Templates object.
     */
    public Templates() {
        super(Devicemgt.NAMESPACE, "templates");
    }

    /**
     * Constructor for an initialized Templates object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Templates(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "templates");
     ...
     * @param uuidValue Key argument of child.
     */
    public Templates(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "templates");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
    ...
    public Templates clone() {
        Templates copy;
        try {
            copy = new Templates(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Templates)cloneContent(copy);
    }
    ...
    public Templates cloneShallow() {
        ...
        return (Templates)cloneShallowContent(copy);
    }
