 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/softwares"
 * <p>
 * See line 442 in
 ...
 */
public class Softwares extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/softwares");
    ...
    /**
     * Constructor for an empty Softwares object.
     */
    public Softwares() {
        super(Devicemgt.NAMESPACE, "softwares");
    }

    /**
     * Constructor for an initialized Softwares object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Softwares(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "softwares");
     ...
     * @param uuidValue Key argument of child.
     */
    public Softwares(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "softwares");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public Softwares clone() {
        Softwares copy;
        try {
            copy = new Softwares(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Softwares)cloneContent(copy);
    }
    ...
    public Softwares cloneShallow() {
        ...
        return (Softwares)cloneShallowContent(copy);
    }
