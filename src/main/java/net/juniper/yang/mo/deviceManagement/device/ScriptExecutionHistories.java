/* 
 * @(#)ScriptExecutionHistories.java        1.0 19/01/15
 *
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/scriptExecutionHistories"
 * <p>
 * See line 429 in
 ...
 */
public class ScriptExecutionHistories extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/scriptExecutionHistories");
    ...
    /**
     * Constructor for an empty ScriptExecutionHistories object.
     */
    public ScriptExecutionHistories() {
        super(Devicemgt.NAMESPACE, "scriptExecutionHistories");
    }

    /**
     * Constructor for an initialized ScriptExecutionHistories object,
     * 
     * @param uuidValue Key argument of child.
     */
    public ScriptExecutionHistories(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "scriptExecutionHistories");
     ...
     * @param uuidValue Key argument of child.
     */
    public ScriptExecutionHistories(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "scriptExecutionHistories");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public ScriptExecutionHistories clone() {
        ScriptExecutionHistories copy;
        try {
            copy = new ScriptExecutionHistories(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (ScriptExecutionHistories)cloneContent(copy);
    }
     ...
     */
    public ScriptExecutionHistories cloneShallow() {
        ScriptExecutionHistories copy;
        try {
            copy = new ScriptExecutionHistories(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (ScriptExecutionHistories)cloneShallowContent(copy);
    }
