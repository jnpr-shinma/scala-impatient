...
import net.juniper.yang.mo.deviceManagement.changeLog.IdPerms;
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/changeLog"
 * <p>
 * See line 716 in
 ...
 */
public class ChangeLog extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("changeLog");
    ...
    /**
     * Constructor for an empty ChangeLog object.
     */
    public ChangeLog() {
        super(Devicemgt.NAMESPACE, "changeLog");
        setDefaultPrefix();
        setPrefix(Devicemgt.PREFIX);
    }

    /**
     * Constructor for an initialized ChangeLog object,
     * 
     * @param uuidValue Key argument of child.
     */
    public ChangeLog(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "changeLog");
        setDefaultPrefix();
        setPrefix(Devicemgt.PREFIX);
     ...
     * @param uuidValue Key argument of child.
     */
    public ChangeLog(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "changeLog");
        setDefaultPrefix();
        setPrefix(Devicemgt.PREFIX);
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
    ...
    public ChangeLog clone() {
        ChangeLog copy;
        try {
            copy = new ChangeLog(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (ChangeLog)cloneContent(copy);
    }
    ...
    public ChangeLog cloneShallow() {
        ...
        return (ChangeLog)cloneShallowContent(copy);
    }
