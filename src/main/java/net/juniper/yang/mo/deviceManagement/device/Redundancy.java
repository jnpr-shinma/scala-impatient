...
import net.juniper.yang.mo.deviceManagement.RedundancyStatusEnum;
import net.juniper.yang.mo.deviceManagement.device.redundancy.Peer;

/**
 * This class represents an element from 
 * the namespace http://juniper.net/ns/space/device-management/1.0
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/redundancy"
 * <p>
 * See line 333 in
...
public class Redundancy extends YangElement {
    ...
    public static final Tagpath TAG_PATH = new Tagpath("device/redundancy");
     ...
     */
    public Redundancy() {
        super(Devicemgt.NAMESPACE, "redundancy");
    }
     ...
     * @return The value of the leaf.
     */
    public RedundancyStatusEnum getStatusValue() throws JNCException {
        return (RedundancyStatusEnum)getValue("status");
    }
     ...
     */
    public void setStatusValue(RedundancyStatusEnum statusValue)
            throws JNCException {
        setLeafValue(Devicemgt.NAMESPACE,
            "status",
            statusValue,
    ...
    public void setStatusValue(String statusValue) throws JNCException {
        setStatusValue(new RedundancyStatusEnum(statusValue));
    }
     ...
     */
    public Peer getPeer(DeviceIdRef uuidValue) throws JNCException {
        String path = "peer[uuid='" + uuidValue + "']";
     ...
     * @param uuidValue Key argument of child.
     */
    public Peer getPeer(String uuidValue) throws JNCException {
        String path = "peer[uuid='" + uuidValue + "']";
        return (Peer)searchOne(path);
    }
     ...
     * @return The added child.
     */
    public Peer addPeer(DeviceIdRef uuidValue) throws JNCException {
        Peer peer = new Peer(uuidValue);
        return addPeer(peer);
    }
     ...
     * @return The added child.
     */
    public Peer addPeer(String uuidValue) throws JNCException {
        Peer peer = new Peer(uuidValue);
        return addPeer(peer);
    }
     ...
     * @param uuidValue Key argument of child.
     */
    public void deletePeer(DeviceIdRef uuidValue) throws JNCException {
        String path = "peer[uuid='" + uuidValue + "']";
        delete(path);
    }
     ...
     * @param uuidValue Key argument of child.
     */
    public void deletePeer(String uuidValue) throws JNCException {
        String path = "peer[uuid='" + uuidValue + "']";
        delete(path);
    }
