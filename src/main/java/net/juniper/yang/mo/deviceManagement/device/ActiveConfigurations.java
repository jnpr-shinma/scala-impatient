/* 
 * @(#)ActiveConfigurations.java        1.0 19/01/15
 *
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/activeConfigurations"
 * <p>
 * See line 408 in
 ...
 */
public class ActiveConfigurations extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/activeConfigurations");
    ...
    /**
     * Constructor for an empty ActiveConfigurations object.
     */
    public ActiveConfigurations() {
        super(Devicemgt.NAMESPACE, "activeConfigurations");
    }

    /**
     * Constructor for an initialized ActiveConfigurations object,
     * 
     * @param uuidValue Key argument of child.
     */
    public ActiveConfigurations(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "activeConfigurations");
     ...
     * @param uuidValue Key argument of child.
     */
    public ActiveConfigurations(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "activeConfigurations");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public ActiveConfigurations clone() {
        ActiveConfigurations copy;
        try {
            copy = new ActiveConfigurations(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (ActiveConfigurations)cloneContent(copy);
    }
     ...
     */
    public ActiveConfigurations cloneShallow() {
        ActiveConfigurations copy;
        try {
            copy = new ActiveConfigurations(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (ActiveConfigurations)cloneShallowContent(copy);
    }
