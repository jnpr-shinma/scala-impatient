/* 
 * @(#)StagedImages.java        1.0 19/01/15
 *
 ...
 * generated to "/home/maxin/space/js-ems/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/deviceManagement/device/stagedImages"
 * <p>
 * See line 438 in
 ...
 */
public class StagedImages extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("device/stagedImages");
    ...
    /**
     * Constructor for an empty StagedImages object.
     */
    public StagedImages() {
        super(Devicemgt.NAMESPACE, "stagedImages");
    }

    /**
     * Constructor for an initialized StagedImages object,
     * 
     * @param uuidValue Key argument of child.
     */
    public StagedImages(Uuid uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "stagedImages");
     ...
     * @param uuidValue Key argument of child.
     */
    public StagedImages(String uuidValue) throws JNCException {
        super(Devicemgt.NAMESPACE, "stagedImages");
        Leaf uuid = new Leaf(Devicemgt.NAMESPACE, "uuid");
     ...
     */
    public StagedImages clone() {
        StagedImages copy;
        try {
            copy = new StagedImages(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (StagedImages)cloneContent(copy);
    }
     ...
     */
    public StagedImages cloneShallow() {
        StagedImages copy;
        try {
            copy = new StagedImages(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (StagedImages)cloneShallowContent(copy);
    }
