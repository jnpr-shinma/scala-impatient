...
package net.juniper.yang.mo.tcPetStore.tcAccount;
 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcAccount/signnos"
 * <p>
 * See line 60 in
 ...
 */
public class Signnos extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tcAccount/signnos");
    ...
    /**
     * Constructor for an empty Signnos object.
     */
    public Signnos() {
        super(PetStoreTestcase.NAMESPACE, "signnos");
    }

    /**
     * Constructor for an initialized Signnos object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Signnos(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "signnos");
     ...
     * @param uuidValue Key argument of child.
     */
    public Signnos(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "signnos");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
     ...
     */
    public Signnos clone() {
        Signnos copy;
        try {
            copy = new Signnos(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Signnos)cloneContent(copy);
    }
    ...
    public Signnos cloneShallow() {
        ...
        return (Signnos)cloneShallowContent(copy);
    }
