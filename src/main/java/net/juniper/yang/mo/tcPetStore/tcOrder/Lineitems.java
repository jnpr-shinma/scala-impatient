 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcOrder/lineitems"
 * <p>
 * See line 38 in
 ...
 */
public class Lineitems extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tcOrder/lineitems");
    ...
    /**
     * Constructor for an empty Lineitems object.
     */
    public Lineitems() {
        super(PetStoreTestcase.NAMESPACE, "lineitems");
    }

    /**
     * Constructor for an initialized Lineitems object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Lineitems(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "lineitems");
     ...
     * @param uuidValue Key argument of child.
     */
    public Lineitems(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "lineitems");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
    ...
    public Lineitems clone() {
        Lineitems copy;
        try {
            copy = new Lineitems(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Lineitems)cloneContent(copy);
    }
    ...
    public Lineitems cloneShallow() {
        ...
        return (Lineitems)cloneShallowContent(copy);
    }
