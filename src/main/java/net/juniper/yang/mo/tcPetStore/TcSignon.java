...
import net.juniper.yang.mo.tcPetStore.tcSignon.IdPerms;

/**
 * This class represents an element from 
 * the namespace http://www.juniper.net/ns/testcase-pet-store
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tc-signon"
 * <p>
 * See line 66 in
 ...
 */
public class TcSignon extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tc-signon");
    ...
    /**
     * Constructor for an empty TcSignon object.
     */
    public TcSignon() {
        super(PetStoreTestcase.NAMESPACE, "tc-signon");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
    }

    /**
     * Constructor for an initialized TcSignon object,
     * 
     * @param uuidValue Key argument of child.
     */
    public TcSignon(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-signon");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
     ...
     * @param uuidValue Key argument of child.
     */
    public TcSignon(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-signon");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
     ...
     */
    public TcSignon clone() {
        TcSignon copy;
        try {
            copy = new TcSignon(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (TcSignon)cloneContent(copy);
    }
    ...
    public TcSignon cloneShallow() {
        ...
        return (TcSignon)cloneShallowContent(copy);
    }
     ...
     * @return The value of the leaf.
     */
    public YangString getUsernameValue() throws JNCException {
        return (YangString)getValue("username");
    }
     ...
     */
    public void setUsernameValue(YangString usernameValue) throws JNCException {
    ...
    public void setUsernameValue(String usernameValue) throws JNCException {
        setUsernameValue(new YangString(usernameValue));
    }
    ...
    /**
     * Gets the value for child leaf "password".
     * @return The value of the leaf.
     */
    public YangString getPasswordValue() throws JNCException {
        return (YangString)getValue("password");
    }

    /**
     * Sets the value for child leaf "password",
     * using instance of generated typedef class.
     * @param passwordValue The value to set.
     * @param passwordValue used during instantiation.
     */
    public void setPasswordValue(YangString passwordValue) throws JNCException {
        setLeafValue(PetStoreTestcase.NAMESPACE,
            "password",
            passwordValue,
            childrenNames());
     ...
     * @param passwordValue used during instantiation.
     */
    public void setPasswordValue(String passwordValue) throws JNCException {
        setPasswordValue(new YangString(passwordValue));
    }

    /**
     * Unsets the value for child leaf "password".
     */
    public void unsetPasswordValue() throws JNCException {
        delete("password");
    }

    /**
     * This method is used for creating a subtree filter.
     * The added "password" leaf will not have a value.
     */
    public void addPassword() throws JNCException {
        setLeafValue(PetStoreTestcase.NAMESPACE,
            "password",
            null,
            childrenNames());
    ...
    /**
     * Marks the leaf "password" with operation "replace".
     */
    public void markPasswordReplace() throws JNCException {
        markLeafReplace("password");
    }

    /**
     * Marks the leaf "password" with operation "merge".
     */
    public void markPasswordMerge() throws JNCException {
        markLeafMerge("password");
    }

    /**
     * Marks the leaf "password" with operation "create".
     */
    public void markPasswordCreate() throws JNCException {
        markLeafCreate("password");
    }

    /**
     * Marks the leaf "password" with operation "delete".
     */
    public void markPasswordDelete() throws JNCException {
        markLeafDelete("password");
    }
