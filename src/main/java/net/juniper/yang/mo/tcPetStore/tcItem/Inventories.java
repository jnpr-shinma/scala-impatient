...
package net.juniper.yang.mo.tcPetStore.tcItem;
 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcItem/inventories"
 * <p>
 * See line 135 in
...
public class Inventories extends YangElement {
    ...
    public static final Tagpath TAG_PATH = new Tagpath("tcItem/inventories");
     ...
     */
    public Inventories() {
        super(PetStoreTestcase.NAMESPACE, "inventories");
    }

    /**
     * Constructor for an initialized Inventories object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Inventories(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "inventories");
     ...
     * @param uuidValue Key argument of child.
     */
    public Inventories(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "inventories");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
    ...
    public Inventories clone() {
        Inventories copy;
        try {
            copy = new Inventories(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Inventories)cloneContent(copy);
    }
    ...
    public Inventories cloneShallow() {
        ...
        return (Inventories)cloneShallowContent(copy);
    }
