/* 
 * @(#)Orderstatuss.java        1.0 12/01/15
 *
...
package net.juniper.yang.mo.tcPetStore.tcOrder;
 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcOrder/orderstatuss"
 * <p>
 * See line 33 in
 ...
 */
public class Orderstatuss extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tcOrder/orderstatuss");
    ...
    /**
     * Constructor for an empty Orderstatuss object.
     */
    public Orderstatuss() {
        super(PetStoreTestcase.NAMESPACE, "orderstatuss");
    }

    /**
     * Constructor for an initialized Orderstatuss object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Orderstatuss(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "orderstatuss");
     ...
     * @param uuidValue Key argument of child.
     */
    public Orderstatuss(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "orderstatuss");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
     ...
     */
    public Orderstatuss clone() {
        Orderstatuss copy;
        try {
            copy = new Orderstatuss(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Orderstatuss)cloneContent(copy);
    }
     ...
     */
    public Orderstatuss cloneShallow() {
        Orderstatuss copy;
        try {
            copy = new Orderstatuss(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (Orderstatuss)cloneShallowContent(copy);
    }
