...
import net.juniper.yang.mo.tcPetStore.tcProduct.IdPerms;
import net.juniper.yang.mo.tcPetStore.tcProduct.Items;

/**
 * This class represents an element from 
 * the namespace http://www.juniper.net/ns/testcase-pet-store
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tc-product"
 * <p>
 * See line 112 in
 ...
 */
public class TcProduct extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tc-product");
    ...
    /**
     * Constructor for an empty TcProduct object.
     */
    public TcProduct() {
        super(PetStoreTestcase.NAMESPACE, "tc-product");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
    }

    /**
     * Constructor for an initialized TcProduct object,
     * 
     * @param uuidValue Key argument of child.
     */
    public TcProduct(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-product");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
     ...
     * @param uuidValue Key argument of child.
     */
    public TcProduct(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-product");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
     ...
     */
    public TcProduct clone() {
        TcProduct copy;
        try {
            copy = new TcProduct(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (TcProduct)cloneContent(copy);
    }
    ...
    public TcProduct cloneShallow() {
        ...
        return (TcProduct)cloneShallowContent(copy);
    }
