 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcOrder/accounts"
 * <p>
 * See line 43 in
 ...
 */
public class Accounts extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tcOrder/accounts");
    ...
    /**
     * Constructor for an empty Accounts object.
     */
    public Accounts() {
        super(PetStoreTestcase.NAMESPACE, "accounts");
    }

    /**
     * Constructor for an initialized Accounts object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Accounts(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "accounts");
     ...
     * @param uuidValue Key argument of child.
     */
    public Accounts(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "accounts");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
    ...
    public Accounts clone() {
        Accounts copy;
        try {
            copy = new Accounts(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Accounts)cloneContent(copy);
    }
    ...
    public Accounts cloneShallow() {
        ...
        return (Accounts)cloneShallowContent(copy);
    }
