...
package net.juniper.yang.mo.tcPetStore.tcLineitem;
 ...
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tcLineitem/items"
 * <p>
 * See line 92 in
 ...
 */
public class Items extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tcLineitem/items");
    ...
    /**
     * Constructor for an empty Items object.
     */
    public Items() {
        super(PetStoreTestcase.NAMESPACE, "items");
    }

    /**
     * Constructor for an initialized Items object,
     * 
     * @param uuidValue Key argument of child.
     */
    public Items(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "items");
     ...
     * @param uuidValue Key argument of child.
     */
    public Items(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "items");
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
    ...
    public Items clone() {
        Items copy;
        try {
            copy = new Items(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Items)cloneContent(copy);
    }
    ...
    public Items cloneShallow() {
        ...
        return (Items)cloneShallowContent(copy);
    }
