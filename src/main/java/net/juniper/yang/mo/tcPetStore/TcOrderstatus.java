/* 
 * @(#)TcOrderstatus.java        1.0 12/01/15
 *
...
import net.juniper.yang.mo.tcPetStore.tcOrderstatus.IdPerms;

/**
 * This class represents an element from 
 * the namespace http://www.juniper.net/ns/testcase-pet-store
 * generated to "/home/maxin/myworkspace/js-easy-rest/easy-rest-orm/target/scala-2.11/src_managed/main/net/juniper/yang/mo/tcPetStore/tc-orderstatus"
 * <p>
 * See line 75 in
 ...
 */
public class TcOrderstatus extends YangElement {

    private static final long serialVersionUID = 1L;

    public static final Tagpath TAG_PATH = new Tagpath("tc-orderstatus");
    ...
    /**
     * Constructor for an empty TcOrderstatus object.
     */
    public TcOrderstatus() {
        super(PetStoreTestcase.NAMESPACE, "tc-orderstatus");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
    }

    /**
     * Constructor for an initialized TcOrderstatus object,
     * 
     * @param uuidValue Key argument of child.
     */
    public TcOrderstatus(Uuid uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-orderstatus");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
     ...
     * @param uuidValue Key argument of child.
     */
    public TcOrderstatus(String uuidValue) throws JNCException {
        super(PetStoreTestcase.NAMESPACE, "tc-orderstatus");
        setDefaultPrefix();
        setPrefix(PetStoreTestcase.PREFIX);
        Leaf uuid = new Leaf(PetStoreTestcase.NAMESPACE, "uuid");
     ...
     */
    public TcOrderstatus clone() {
        TcOrderstatus copy;
        try {
            copy = new TcOrderstatus(getUuidValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (TcOrderstatus)cloneContent(copy);
    }
     ...
     */
    public TcOrderstatus cloneShallow() {
        TcOrderstatus copy;
        try {
            copy = new TcOrderstatus(getUuidValue().toString());
        } catch (JNCException e) {
        ...
        return (TcOrderstatus)cloneShallowContent(copy);
    }
     ...
     * @return The value of the leaf.
     */
    public YangString getTimestampValue() throws JNCException {
        return (YangString)getValue("timestamp");
    }
     ...
     */
    public void setTimestampValue(YangString timestampValue)
            throws JNCException {
    ...
    public void setTimestampValue(String timestampValue) throws JNCException {
        setTimestampValue(new YangString(timestampValue));
    }
     ...
     * @return The value of the leaf.
     */
    public YangUInt32 getStatusValue() throws JNCException {
        return (YangUInt32)getValue("status");
    }
     ...
     */
    public void setStatusValue(YangUInt32 statusValue) throws JNCException {
        setLeafValue(PetStoreTestcase.NAMESPACE,
            "status",
            statusValue,
            childrenNames());
     ...
     * @param statusValue used during instantiation.
     */
    public void setStatusValue(long statusValue) throws JNCException {
        setStatusValue(new YangUInt32(statusValue));
    }
