...
/**
 * The root class for namespace http://juniper.net/ns/space/paradigm/1.0 (accessible from 
 * Paradigmmgt.NAMESPACE) with prefix "paramgt" (Paradigmmgt.PREFIX).
 *
 * @version 1.0 2014-12-26
 * @author Auto Generated
 */
public class Paramgt {

    public static final String NAMESPACE = "http://juniper.net/ns/space/paradigm/1.0";

    public static final String PREFIX = "paramgt";
    ...
    public static void enable() {
        if(enabled)
            return;
        try {
            YangElement.setPackage(NAMESPACE, "net.juniper.jspace.ems.yang.paradigmmgt");
            Paramgt.registerSchema();
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.findAndReadFile("Paramgt.schema", h, Paramgt.class);
    }
